...
{
    Metadata metadata;
    assert(metadata.enPassantCol == -1);
    ...
    EXPECT_TRUE(isCellInCheck(board0, 5, 2, metadata));
    ...
    EXPECT_TRUE(isCellInCheck(board1, 7, 2, metadata));
    ...
    EXPECT_TRUE(isCellInCheck(board2, 7, 6, metadata));
    ...
    EXPECT_TRUE(isCellInCheck(board3, 3, 2, metadata));
    ...
    EXPECT_FALSE(isCellInCheck(board4, 3, 7, metadata));
    ...
    EXPECT_FALSE(isCellInCheck(board5, 0, 0, metadata));
    ...
    EXPECT_FALSE(isCellInCheck(board6, 4, 4, metadata));
    ...
    EXPECT_FALSE(isCellInCheck(board7, 5, 3, metadata));
